...
@implementation XHLock9PointView
...
- (void)touchesEnded:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    ...
    //查看按钮选中顺序
    NSLog(@"%@", s);
    if ([s isEqualToString:@"0 3 6 7 8 "]) {
        
        [self lockPathSuccess];
    }
}
- (void)lockPathSuccess {}
