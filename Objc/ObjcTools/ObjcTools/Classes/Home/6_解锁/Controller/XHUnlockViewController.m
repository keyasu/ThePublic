...
#import "XHUnlockViewController.h"
#import "XHHomeViewCell.h"
#import "XHHomeViewModel.h"


@interface XHUnlockViewController ()
...
@implementation XHUnlockViewController
...
- (NSArray *)getArrray {
    NSArray * arr = @[
        ...
        @{@"tStr": @"XHLocalAuthViewController", @"dStr": @"指纹验证"},
