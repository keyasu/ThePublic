...
#import "XHGCDViewController.h"

@interface XHGCDViewController ()

@end

@implementation XHGCDViewController
...
- (void)btnActioinWith:(int)i {
    switch (i) {
        case 0:
        {
            [self analysis_Async_Concurrent];
        }
            break;
        case 1:
        {
            //
            [self analysis_Async_Serial];
        }
            break;
        case 2:
            [self analysis_Sync_Concurrent];
            break;
        case 3:
            [self analysis_Sync_Serial];
            break;
        case 4:
            [self analysis_Async_Main];
            break;
        case 5:
            [self analysis_Sync_Main];
            break;
        case 6:
            [self CGD_Group];
            break;
        case 7:
            [self GCD_Enter_Leave];
            break;
        case 8:
            [self GCD_Barrier];
            break;
...
- (void)analysis_Async_Concurrent {
